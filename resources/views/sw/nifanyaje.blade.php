 ...
 <!-- contents -->
    ...
    <div class="container px-0">
        <div class="col-12 special-page">
            ...
            <strong><p>Nifanyeje kupata Huduma zinazohusu Istilahi?</p></strong>

<p style="text-align:justify"><span style="font-size:12pt"><span style="font-family:&quot;Times New Roman&quot;,serif"><span style="font-family:&quot;Arial&quot;,sans-serif">Mtu, shirika, taasisi au Kampuni ambayo inapata shida katika kupata istilahi za Kiswahili zinazoendana na shughuli zake iwasilishe istilahi hizo BAKITA kwa njia ya simu, barua pepe na kwa njia ya barua za kawaida. Aidha, mtu binafsi anaweza kuja BAKITA kupata ushauri wa chochote kinachohusiana na maneno mbalimbali ya Kiswahili.
            ...
            <strong><p>Nifanyeje, kupata Huduma ya Tafsiri?
</p></strong>
...
<p style="text-align:justify"><span style="font-size:12pt"><span style="font-family:&quot;Times New Roman&quot;,serif"><span style="font-family:&quot;Arial&quot;,sans-serif">Taratibu za kufuata wakati wa kumpatia mteja ithibati ya muswada au kitabu chake ni kama ifuatavyo:Fika ofisini na muswada wako ukiwa katika nakala mango.Muswada utakaguliwa idadi ya kurasa kwa ajili ya kulipia, ambapo gharama za malipo ni sh. 5000/= kwa kila ukurasa.Baada ya kulipia, muswada utasomwa na hatimaye mteja atarudishiwa kitabu chake na kwenda kuingiza marekebisho aliyoshauriwa.Ukisha kuingiza marekebisho hayo, atakirudisha tena kwa ajili ya kuhakikiwa kama umeingiza kwa usahihi marekebisho hayo, kadiri ya maelekezo uliyopewa.Ikiwa marekebisho hayo yatakuwa yameingizwa kama ilivyoshauriwa, kitabu au muswada utagongwa muhuri na hatimaye mteja atapatiwa cheti cha ithibati kwa ajili ya kitabu chake, kuwa kinafaa kutumika kwa wadau aliokusudia kwa kuwa sasa kina lugha iliyo fasaha na iliyothibitishwa.
    ...
    <ul class="nav nav-tabs row pl-3" role="tablist" id="myTab">
      <li class="nav-item col-4 float-left px-0 text-left">
         <a class="nav-link active px-0" data-toggle="tab" href="#home" role="tab">Baraza Kwa Ujumla</a> </li>
      
    </ul>
    <h2>
        Nifanyeje kupata Humduma zinazohusu Baraza kwa Ujumla?
    </h2>
    <p>
        Mtu, shirika kampuni au taasisi inayohitaji kufahamishwa chochote au kujua namna ya kupata huduma zinazotolewa na Baraza inaweza kutumia njia zifuatazo:-<br>
1. Tembelea tovuti ya Baraza ambayo ni http://www.bakita.go.tz<br>
2. Kupiga simu Na. 2762243<br>
3. Kuandika Barua kwa Anuani ifuatayo: Baraza la Kiswahili la Taifa<br>
S.L.P. 4766
Dar-Es- Salaam<br>
4. Kuandika barua pepe ambayo ni <a class='nav-link' target='_black' href='https://mail.bakita.go.tz/'>Email BAKITA |</a><br>
5. Kufika katika ofisi za BAKITA zilizo Kijitonyama, kitalu Na. 45.B
