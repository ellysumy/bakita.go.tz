...
<div class="row row-cols-1 row-cols-md-2 g-4">
  ...
  <div class="card" style="text-align:justify"><span style="font-size:12pt font-family:&quot;Times New Roman&quot;,serif">
    ...
    <div class="col">
      <div class="card-body">
        <h5 class="card-title">Kitengo cha TEHAMA na Takwimu</h5>
...
<div class="col">
          <div class="card" style="text-align:justify"><span style="font-size:12pt font-family:&quot;Times New Roman&quot;,serif">
            <div class="col">
              <h5 class="card-title">Masoko na Uhusiano  na Umma</h5>
              ...
              Majukumu ya kitengo hiki ni kama ifuatavyo;</p>
              <p>
                <ol type="i">
                  <li>
  ...
  <div class="row row-cols-1 row-cols-md-2 g-4">
    <div class="col">
          <div class="card" style="text-align:justify"><span style="font-size:12pt font-family:&quot;Times New Roman&quot;,serif">
            <div class="col">
              <h5 class="card-title">Kitengo cha Ukaguzi wa Ndani</h5>
        ...
        <!-- Starting new cards -->
  <div class="col">
  <div class="card" ><span style="text-align:justify font-size:12pt font-family:&quot;Times New Roman&quot;,serif">
