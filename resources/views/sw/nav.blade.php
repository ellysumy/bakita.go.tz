                ...
                <div class="row top_nav px-0">
                    ...
                    <div class="col-7 sm-hide px-0">
                        <ul class="list-inline mx-auto justify-content-end text-white">
                            ...
                            <li class='nav-item'><a class='nav-link' href='/maswali'>Maswali ya mara kwa mara |</a></li></li><li class='nav-item'><a class='nav-link' target='_black' href='https://mail.bakita.go.tz/'>Baruapepe BAKITA |</a></li></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="collapse navbar-collapse col-12 px-0" id="middleNavbarMenu">
                    <ul class="navbar-nav mr-auto nav-bottom-header ml-lg-2 justify-content-start d-flex">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="/kuhusu" role="button" aria-expanded="false">Kuhusu BAKITA</a>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="/utawala">Utumishi na Utawala</a></li>
                              <li><a class="dropdown-item" href="/utawala">Tafsiri na Ukalimani</a></li>                        
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="/idara">Idara za Baraza</a></li>
                        </ul>
                      </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="/utawala" role="button" aria-expanded="false">Utawala</a>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="/utawala">Board</a></li>
                              <li><a class="dropdown-item" href="/muundo">Muundo wa BAKITA</a></li>                        
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="/idara">Idara Za BAKITA</a></li>
                        </ul>
                      </li>
                    
                        <li class='nav-item'>
                          <a class='nav-link' href='https://www.swahiliprime.com/'> Swahili Prime</a>
                        </li>
                        <li class='nav-item'>
                          <a class='nav-link' href='https://bakita.tk/blogu'>Kituo cha Habari</a>
                        </li>
                        <li class='nav-item'>
                          <a class='nav-link' href='/maswali'>Maswali ya mara kwa mara</a></li>
                        

                          
                        <!-- IDEA: to show top menu on bottom menu -->
                        <li class='list-inline-item xs-show'><a href='/maswali'>Maswali ya mara kwa mara |</a></li></li><li class='list-inline-item xs-show'><a target='_black' href='https://mail.bakita.go.tz/'>Baruapepe|</a></li></li>
                    </ul>
