                ...
                <div class="row top_nav px-0">
                    ...
                    <div class="col-7 sm-hide px-0">
                        <ul class="list-inline mx-auto justify-content-end text-white">
                            ...
                            <li class='nav-item' title="Maswali ya mara kawa mara"><a class='nav-link' href='/maswali'>Maswali |</a></li></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="navbar-nav mr-auto nav-bottom-header ml-lg-2 justify-content-start d-flex">
                        <li class="nav-item active">
                            <a class="nav-link" href="/sw">
                                ...
                                <span class="mt-0 pt-0">Nyumbani</span>
                            </a>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="/kuhusu" role="button" aria-expanded="false">Kuhusu Sisi</a>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="/historia">Historia ya BAKITA</a></li>
                              <li><a class="dropdown-item" href="/bodi">Bodi ya Wakurugenzi</a></li>                        
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="/salamu">Salamu za Katibu Mtendaji</a></li>
                              <li><a class="dropdown-item" href="/mising-mikuu">Msingi Mkuu wa Baraza</a></li>
                              <li><a class="dropdown-item" href="/dira-dhamira">Dira na Dhamira</a></li>
                              <li><a class="dropdown-item" href="/majukumu">Majukumu ya Baraza</a></li>
                        </ul>
                      </li>
                      <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="/kuhusu" role="button" aria-expanded="false">Utawala</a>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="/muundo">Muundo wa Baraza</a></li>
                              <li><a class="dropdown-item" href="/kurugenzi">Kurugenzi</a></li>                        
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="/sehemu">Sehemu</a>
                                <li><a class="dropdown-item" href="/vitengo">Vitengo</a></li>
                        </ul>
                      </li>
                        <li class='nav-item'>
                          <a class='nav-link' href='/huduma'>Huduma za Baraza</a>
                        </li>
                        
                        
                        
                        <li class='nav-item'>
                          <a class='nav-link' href='https://bakita.tk/blogu'>Kituo cha Habari</a>
                        </li>
                        <li class='nav-item'>
                          <a class='nav-link hovertext' title="Wasiliana nasi" href='/maktaba'>Maktaba </a>
                      </li>
                        <li class='nav-item'>
                          <a class='nav-link hovertext' title="Wasiliana nasi" href='/wasiliana'>Wasiliana Nasi </a>
                      </li>
                      <li class='nav-item'>
                          <a class='nav-link hovertext' title="Wasiliana nasi" href='/jifunze'>Jifunze Kiswahili </a>
                      </li>
                          
                        <!-- IDEA: to show top menu on bottom menu -->
                        <li class='list-inline-item xs-show'><a href='/faqs'>Maswali ya Mara kwa Mara |</a></li></li><li class='list-inline-item xs-show'><a target='_black' href='https://mail.bakita.go.tz/'>Baruapepe|</a></li></li>
                    </ul>
                    ...
                    <ul class="list-inline  my-0 justify-content-end ">
                        <li class="list-inline-item top_nav sm-hidde pr-2 my-0">
                            <div class="search-form rounded-medium overflow-hidden  form-group my-0">
                                ...
                                <input class="form-control input  " style="min-width:170px" type="text"  name="q"  placeholder="Search" aria-label="Search">
