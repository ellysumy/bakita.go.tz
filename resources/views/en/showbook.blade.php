...
<div class="card mb-3">
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h4 class="card-title">Book Name: {{$book->name}}</h4>
        <p class="card-text text-xl text-gray-700 pt-8 pb-10 leading-8 font-light"> <b>Book Descriptions</b><br>{{$book->description}}
        </p>
        <hr>
    ...
    <hr>
    <b>Publisher: </b>{{$book->publisher}}</p>
  ...
  <div><a class="button" href="/bookslist"> Other Books</a></div>
</div>
