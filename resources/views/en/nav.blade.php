                ...
                <div class="row top_nav px-0">
                    ...
                    <div class="col-7 sm-hide px-0">
                        <ul class="list-inline mx-auto justify-content-end text-white">
                            ...
                            <li class='nav-item'><a class='nav-link' href='/maswali' title="Frequently Asked Questions">FAQs |</a></li></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="collapse navbar-collapse col-12 px-0" id="middleNavbarMenu">
                    <ul class="navbar-nav mr-auto nav-bottom-header ml-lg-2 justify-content-start d-flex">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="/kuhusu" role="button" aria-expanded="false">About Us</a>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="/utawala">The History of National Kiswahili Council</a></li>
                              <li><a class="dropdown-item" href="/utawala">Directors Board</a></li>                        
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="/greetings">Executive Secretary's Greetings</a></li>
                              <li><a class="dropdown-item" href="/cvalues">Core Values</a></li>
                              <li><a class="dropdown-item" href="/vision-mision">Vision and Mission</a></li>
                              <li><a class="dropdown-item" href="/bakita-functions">Functions of National Kiswahili Council</a></li>
                        </ul>
                      </li>
                        <li class='nav-item'>
                          <a class='nav-link' href='/services'>Council Services</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="/kuhusu" role="button" aria-expanded="false">Administration</a>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="/directorates">Directorates</a></li>
                              <li><a class="dropdown-item" href="/structure">Structure</a></li>                        
                              <li><hr class="dropdown-divider"></li>
                              <li><a class="dropdown-item" href="/sections">Sections</a>
                        ...
                        <li class='nav-item'>
                          <a class='nav-link' href='https://bakita.tk/blogu'>News Station</a>
                        </li>
                        <li class='nav-item'>
                        ...
                        <li class='nav-item'>
                          ...
                          <li class='nav-item'>
                          <a class='nav-link' href='/learnswahili'>Learn Sawhili</a></li>
                        

                          
                        <!-- IDEA: to show top menu on bottom menu -->
                        <li class='list-inline-item xs-show'><a href='/faqs'>Frequently Asked Questions |</a></li></li><li class='list-inline-item xs-show'><a target='_black' href='https://mail.bakita.go.tz/'>Email|</a></li></li>
                    </ul>
