...
<!--                                       <div class="carousel-item rounded-0 ">
          ...
          <div class="main-content-inside mt-3 pb-2">
            <div class="col-md-12  px-md-2">
              <h4 class="my-2 text-center   section-header">About BAKITA</h4>
              <p>
          ...
          <div class="main-content-inside mt-3 pb-2">
            <div class="col-md-12  px-md-2">
              <h4 class="my-2 text-center   section-header">Service Offered by BAKITA </h4>
              @include('en.service')
            </div>
          </div>
        </div>
          ...
          <div class="main-content-inside mt-3 pb-2">
            <div class="col-md-12  px-md-2">
                <h4 class="my-2 text-center   section-header">Latest News </h4>
           ...
           <div class="mb-4 mt-2 main-content-inside pl-md-3  ">
              <div class="row  px-3 px-md-0 ">
                <div class="col-md-6 ">
                      <h4 class="mb-2 text-center px-xs-2 section-header">Announcements </h4>
                    <div class=" mt-4   ">
                 ...
                 <div class="col-md-6 pr-0">
                  <h4 class="mb-2 w-100 text-center  section-header">Publications </h4>
...
<div class="home-page container" >
 <div class="slider">
  <h4 class="my-2 text-center   section-header">BAKITA BOOKS</h4>
...
<a href="#" class="read d-block">Order Now<i class="fa fa-angle-right"></i></a>
</div>
@endforeach
 </div>
<div class="text-right mt-2">
...
<h4 class="my-2 text-center   section-header">Online Swahili Words </h4>
<!-- Slideshow container -->
