    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
     ...
     <form method='POST' action='{{ route('books.store') }}' enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">IBSN</label>
                                    <input type="text" name="isbn" class="form-control border border-2 p-2" value="{{ old('isbn') }}">
                                    @error('isbn')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="price" class="form-control border border-2 p-2" value="{{ old('price') }}">
                                    @error('price')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea class="form-control border border-2 p-2"
                                        placeholder=" Book descriptions" id="floatingTextarea2" name="description"
                                        rows="4" cols="50">{{ old('description')}}
                                    </textarea>
                                        @error('description')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
